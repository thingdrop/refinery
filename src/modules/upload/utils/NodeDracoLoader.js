/* eslint-disable */
// Source: github.com/Scandy-co/vr-playground/blob/500e7891811a06cd4447b685de1d0a14c97c05b1/asset-mgmt/NodeDRACOLoader.js
import * as draco3dgltf from 'draco3dgltf';
const decoder = draco3dgltf.createDecoderModule();

/**
 * @param {THREE.LoadingManager} manager
 */
module.exports = THREE.DRACOLoader = function (manager = null) {
  this.timeLoaded = 0;
...
THREE.DRACOLoader.prototype = {
  ...
  decodeDracoFileInternal: async function (
    rawBuffer,
    dracoDecoderPromise,
    callback,
    attributeUniqueIdMap,
     ...
     */
    const dracoDecoder = await dracoDecoderPromise;
